...
const FormSendOTP = ({ onSetStep, onSetEmail, email }: FormSendOTPType) => {
  ...
  return (
    ...
    >
      <p className="text-center text-sm font-semibold my-3 md:max-w-[60%] mx-auto">
        Vui lòng nhập vào email mà bạn sẽ đăng ký tài khoản. Chúng tôi sẽ gửi mã
        xác thực đến email này
      </p>
...
export default memo(FormSendOTP);
