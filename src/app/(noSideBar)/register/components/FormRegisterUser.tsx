  ...
  const onSubmit = async (data: RegisterFormData) => {
    ...
    if (data.avatar?.[0]) {
      ...
      try {
        ...
        const res = await fetch(`${envConfig.BACKEND_URL}/upload/image`, {
          method: "POST",
          body: formData,
          headers: {
            "Content-Type": "application/json",
          ...
          <div className="md:w-1/2 flex flex-col gap-y-3">
            ...
            <div>
              <Label className="mb-2" htmlFor="name">
                Tên hiển thị <span className="text-xs text-red-500">( * )</span>
              </Label>
            ...
            <div>
              <Label className="mb-2" htmlFor="password">
                Mật khẩu <span className="text-xs text-red-500">( * )</span>
              </Label>
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    <SelectContent className="!bg-primary-gray">
                      ...
                      <SelectItem value="N/A">Không chia sẻ</SelectItem>
                    </SelectContent>
                  </Select>
                )}
              />
