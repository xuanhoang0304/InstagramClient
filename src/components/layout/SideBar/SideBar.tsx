            ...
            <div className="">
                    ...
                    <Link href={"/"} className="pt-[25px] pb-[38px] block sticky top-0 bg-black">
                        <figure>
                            <svg
                                ...
                                className="x1lliihq x1n2onr6 x5n08af ml-3 hidden lg:block"
                                fill="currentColor"
                                height="29"
                                role="img"
                                viewBox="32 4 113 32"
                            ...
                            <Instagram className="ml-3 lg:hidden" />
                        </figure>
                    </Link>
                ) : (
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger
                                className={cn(
                                    "mt-[25px] mb-[38px] block bg-transparent p-3 dark:hover:bg-primary-dark-hover hover:bg-second-gray rounded-lg",
                ...
                <div className=" left-3 right-3 w-full">
                    <ul className="flex flex-col gap-y-3">
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger className="w-full">
                                            <Link
                                                href={item.url || "#"}
                                                className="flex items-center p-3 gap-x-2"
                                            >
                                                <div>{item.icon}</div>
                                                {type == "normal" && (
                                                    <p
                        ...
                        <li className=" bg-transparent dark:hover:bg-primary-dark-hover hover:bg-second-gray rounded-lg">
                            <CreatePost sideBarType={type}></CreatePost>
                        </li>
                        <li
                            className={cn(
                                "bg-transparent dark:hover:bg-primary-dark-hover hover:bg-second-gray rounded-lg",
