...
const ChatPage = () => {
    return (
        <div className="lg:flex hidden w-full  items-center justify-center h-full">
            <div className="flex flex-col items-center">
                ...
                <h2 className="text-xl mt-5">Tin nhắn của bạn</h2>
                <p className="text-sm text-second-gray mt-0.5">
                    Gửi ảnh và tin nhắn riêng tư cho bạn bè hoặc nhóm
                </p>

                <AddGroupsChatBtn
                    trigger={
                        <p className="px-4 mt-3 py-1 bg-primary-blue hover:bg-second-blue transition-colors rounded-lg">
                            Gửi tin nhắn
                        </p>
                    }
                ></AddGroupsChatBtn>
