...
const GroupIdHeading = ({ group }: Props) => {
    ...
    return (
        <header className="flex justify-between items-center px-2 py-4 md:p-4 border-b bg-black border-primary-gray sticky top-0 left-0 right-0 z-10">
