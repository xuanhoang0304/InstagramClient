...
import GroupChatManagerMembers from "./GroupChatManager/GroupChatManagerMembers";
...
export function GroupIdHeadingBtn({ group }: GroupIdHeadingBtnProps) {
    ...
    return (
        <Sheet onOpenChange={handleChange}>
            ...
            <SheetContent className="!w-full xs:!w-3/4 !bg-primary-gray gap-y-2 !h-[100vh] !overflow-y-auto ">
                {!step ? (
                    <>
                        <SheetHeader className="flex flex-col gap-y-2 items-center py-5 ">
                            ...
                            <div className="flex items-center justify-center gap-x-4 mt-4">
                                <div className="flex flex-col gap-y-1 items-center">
                                    <button className="flex  items-center justify-center p-3 bg-second-button-background rounded-full hover:opacity-80 transition-opacity">
                        ...
                        <div>
                            {group.isGroup ? (
                                <GroupSheetAction
                                    icon={
                                        <ContactRound className="size-5  text-second-gray" />
                                    }
                                ...
                                <GroupSheetAction
                                    icon={
                                        <MailSearch className="size-5  text-second-gray" />
                                    }
                                    title="Đổi biệt hiệu"
                                    onClick={() => {
                                        alert("me");
                            ...
                            <GroupSheetAction
                                icon={
                                    <Images className="size-5  text-second-gray" />
                                }
                                title="Ảnh, file, link"
                                onClick={() => {
                                    setStep("media");
                            ...
                            <GroupSheetAction
                                icon={
                                    <Pin className="size-5  text-second-gray" />
                                }
                            ...
                            <GroupSheetAction
                                icon={
                                    <BellOff className="size-5  text-second-gray" />
                                }
                                title="Tắt thông báo"
                                onClick={() => {}}
                            ></GroupSheetAction>
                            <GroupSheetAction
                                icon={
                                    <OctagonAlert className="size-5  text-second-gray" />
                                }
                                title="Báo cáo"
                                onClick={() => {}}
                            ></GroupSheetAction>
                            {group.isGroup &&
                                group.groupAdmin.find(
                                    (u) => u._id === String(myUser?._id)
                                ) && (
                                    <GroupSheetAction
                                        icon={
                                            <Wrench className="size-5  text-second-gray" />
                                        }
                                        title="Quản lý nhóm"
                                        onClick={() => {}}
                                    ></GroupSheetAction>
                            ...
                            <GroupSheetAction
                                icon={
                                    <MessageCircleX className="size-5  text-red-500" />
                                }
