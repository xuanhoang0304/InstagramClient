    ...
    return (
      <>
        ...
        <div className="flex flex-col md:flex-row gap-x-10 gap-y-4 md:max-w-[935px] w-full mx-auto">
          <div className="md:w-[150px] lg:w-[284px] w-full shrink-0 flex  justify-between gap-x-2">
            <Skeleton className="md:size-[150px] size-[60px] rounded-full shrink-0 md:mx-auto"></Skeleton>
  ...
  return (
    <>
        ...
        {!isMyPage ? (
          <>
            <div className="flex items-center gap-x-4">
              ...
              <h3 className="font-bold flex items-center gap-x-1">
                {data.result.name}
                {data.result.isReal && (
                  <svg
      ...
      <div className="flex flex-col md:flex-row gap-x-10 gap-y-2 md:max-w-[935px] w-full mx-auto ">
        {/* avt */}
        <div className=" md:size-[150px] lg:w-[284px] flex-wrap justify-center  xs:justify-start shrink-0 flex  gap-x-4 w-full">
          <figure className="size-[60px] md:size-[150px] rounded-full  md:mx-auto">
            <Image
          ...
          <div className="md:hidden flex flex-1 gap-x-4 justify-center xs:justify-start">
            <MiniUserDetails
