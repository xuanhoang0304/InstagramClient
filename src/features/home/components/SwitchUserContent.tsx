...
export function SwitchUserContent({ trigger, onClose }: Props) {
    ...
    const handleLogin = async (data: LoginFormData) => {
        try {
            ...
            handleError("handleLogin.SwitchUserContent", error);
        }
    };
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleDialogChange}>
            ...
            <DialogContent className="sm:max-w-[425px] !bg-primary-gray z-[70]">
                <form onSubmit={handleSubmit(handleLogin)}>
                    ...
                    <button
                        className="mt-4 w-full rounded-lg px-4 py-2 border border-solid flex items-center gap-x-1 justify-center"
                        type="button"
